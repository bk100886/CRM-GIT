...
namespace Navicon.Core.Entities
{
	...
	public enum nav_invoice_nav_type
	{
		...
		Avtomaticheskoe_sozdanie = 808630001,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Ручное создание", 0, "#0000ff")]
		Ruchnoe_sozdanie = 808630000,
	}
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "9.1.0.45")]
	public enum nav_transmission
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Автоматическая", 0, "#0000ff", "Автоматическая коробка перелач", "1")]
		Avtomaticheskaya = 808630000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Ручная", 1, "#0000ff", "Ручная коробка передач", "2")]
		Ruchnaya = 808630001,
	}
}
