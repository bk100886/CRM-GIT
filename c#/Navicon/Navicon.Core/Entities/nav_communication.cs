...
namespace Navicon.Core.Entities
{
	...
	public partial class nav_communication : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Navicon.Core.Entities.nav_communicationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Navicon.Core.Entities.nav_communicationState)(System.Enum.ToObject(typeof(Navicon.Core.Entities.nav_communicationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Navicon.Core.Entities.Contact nav_contact_nav_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Navicon.Core.Entities.Contact>("nav_contact_nav_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_communication_contactid");
				this.SetRelatedEntity<Navicon.Core.Entities.Contact>("nav_contact_nav_communication_contactid", null, value);
