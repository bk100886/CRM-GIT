...
namespace Navicon.Core.Entities
{
	...
	public partial class nav_agreement : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Navicon.Core.Entities.nav_agreementState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Navicon.Core.Entities.nav_agreementState)(System.Enum.ToObject(typeof(Navicon.Core.Entities.nav_agreementState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Navicon.Core.Entities.nav_invoice> nav_nav_agreement_nav_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Navicon.Core.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_agreement_nav_invoice_dogovorid");
				this.SetRelatedEntities<Navicon.Core.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null, value);
		...
		public Navicon.Core.Entities.Contact nav_contact_nav_agreement_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Navicon.Core.Entities.Contact>("nav_contact_nav_agreement_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_agreement_contact");
				this.SetRelatedEntity<Navicon.Core.Entities.Contact>("nav_contact_nav_agreement_contact", null, value);
		...
		public Navicon.Core.Entities.nav_auto nav_nav_auto_nav_agreement_autoid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Navicon.Core.Entities.nav_auto>("nav_nav_auto_nav_agreement_autoid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_auto_nav_agreement_autoid");
				this.SetRelatedEntity<Navicon.Core.Entities.nav_auto>("nav_nav_auto_nav_agreement_autoid", null, value);
		...
		public Navicon.Core.Entities.nav_credit nav_nav_credit_nav_agreement_creditid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Navicon.Core.Entities.nav_credit>("nav_nav_credit_nav_agreement_creditid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_agreement_creditid");
				this.SetRelatedEntity<Navicon.Core.Entities.nav_credit>("nav_nav_credit_nav_agreement_creditid", null, value);
